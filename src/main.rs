...
fn draw_ship_panel(ships_queue: &[usize]) {
    ...
    draw_text("Statki do postawienia:", start_x, start_y, 24.0, WHITE);
    ...
    if ships_queue.is_empty() {
        ...
        draw_text("Gotowe! Nacisnij ENTER.", start_x, msg_y, 30.0, GREEN);
    }
}
...
async fn main() {
    ...
    loop {
        ...
        match state {
            GameState::Placement => {
                if let Some(&current_len) = ships_queue.first() {
                    ...
                    msg = format!(
                        "Ustawiasz: {} masztowiec ({orient}). [R] - Obrot",
                        current_len,
                        orient = orient_txt
                    );
        ...
        draw_text(title, title_x + 2.0, 57.0, 42.0, BLACK);
        draw_text(title, title_x, 55.0, 42.0, WHITE);

        draw_rectangle(
            player_board.x_pos - 10.0,
            50.0,
            200.0,
            35.0,
            Color::new(0.0, 0.0, 0.0, 0.6),
        );
        draw_text("TY", player_board.x_pos, 80.0, 32.0, WHITE);
        ...
        draw_text("KOMPUTER", enemy_label_x, 80.0, 32.0, WHITE);
        ...
        draw_text(&msg, MARGIN_LEFT, msg_bg_y + 30.0, 30.0, WHITE);
        ...
        draw_line(mx - 8.0, my, mx + 8.0, my, 3.0, BLACK);
        draw_line(mx, my - 8.0, mx, my + 8.0, 3.0, BLACK);
        draw_line(mx - 6.0, my, mx + 6.0, my, 1.0, WHITE);
        draw_line(mx, my - 6.0, mx, my + 6.0, 1.0, WHITE);
